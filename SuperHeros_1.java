/**
 * A very basic SuperHeros_1 class that inherits from, or extends, the basic Person class
 *
 * 
 * @author   Ahmet Yilmaz
 * @version  1.0
...
public class SuperHeros_1 extends Person
{
	...
	*/
	public SuperHeros_1()
	{
		...
		strength = 10;
		secretIdentity = secretIdentity.Clark;
		characterName = characterName.SuperMan;
		numberOfLives = 1;
	}
	...
	* 
	*/
	public SuperHeros_1(String fN, String lN, String sex, byte age, int numLives, int strength)
	{
	...
	*/
	...
	public SuperHeros_1(String fN, String lN, String mN, String title, String suffix, String sex, byte age, int strengthRate, int numLife, characterName characterName, secretIdentity secretIdentity) throws IllegalArgumentException
	{
		...
		if (characterName!= characterName.SuperMan || characterName!=characterName.WonderWoman || characterName!=characterName.KarateKid)
		{
			throw new IllegalArgumentException("All SuperHeros character names must be one of \"WonderWoman\", \"SuperMan\", \"KarateKid\"");
		}
		if (secretIdentity!=secretIdentity.Clark || secretIdentity!=secretIdentity.Engineer || secretIdentity!=secretIdentity.Programmer)
		{
			throw new IllegalArgumentException("All SuperHeros character names must be one of \"WonderWoman\", \"SuperMan\", \"KarateKid\"");
		}
		if (numLife >= 1)
	...
	*/
	public void setCharacterName(characterName charName)
	{
		if (charName!= characterName.SuperMan || charName!=characterName.WonderWoman || charName!=characterName.KarateKid)
		{
			throw new IllegalArgumentException("All SuperHeros character names must be one of \"WonderWoman\", \"SuperMan\", \"KarateKid\"");
		}
	}
	...
	*/
	public void setSecretIdentity(secretIdentity secretID)
	{
		if (secretID!=secretIdentity.Clark || secretID!=secretIdentity.Engineer || secretID!=secretIdentity.Programmer)
		{
			throw new IllegalArgumentException("All SuperHeros secret identities must be one of \"Clark\", \"Engineer\", \"Programmer\"");
		}
	}
